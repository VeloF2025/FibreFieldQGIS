...
class ArchonIntegrationTest:
    ...
    def test_project_setup(self):
        ...
        if claude_md.exists():
            ...
            if "ARCHON INTEGRATION" in content and "fibrefield-project" in content:
                print("✅ CLAUDE.md configured for Archon")
            else:
                print("❌ CLAUDE.md missing Archon configuration")
                return False
        else:
        ...
        if tasks_file.exists():
            try:
                ...
                if len(tasks) >= 5:
                    ...
                    print(f"❌ Only {len(tasks)} tasks found, expected at least 5")
                    return False
            except Exception as e:
                print(f"❌ Invalid tasks file: {e}")
                return False
        else:
            print("❌ Initial tasks file not found")
            return False
    ...
    def test_project_knowledge(self):
        ...
        if knowledge_file.exists():
            try:
                ...
                print(f"✅ Knowledge base index with {len(knowledge)} items")
                ...
                print(f"❌ Invalid knowledge index: {e}")
                return False
        else:
    ...
    def run_full_test(self):
        ...
        if passed == total:
            ...
            print("\n⚠️  Some issues found. Check Archon services and configuration.")
